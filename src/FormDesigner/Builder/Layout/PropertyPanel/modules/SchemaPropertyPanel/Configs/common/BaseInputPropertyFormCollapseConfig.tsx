...
} from "./PropertyFormItemConfig.tsx";

const BaseInputPropertyFormCollapseConfig: IPropertyFormCollapseConfig = {
    key: 'BaseInput',
    label: '输入框公共配置',
    collapseItems: [
        {
...
export default BaseInputPropertyFormCollapseConfig